...
public class ReactPdfViewManager extends ViewGroupManager<PdfView> {
    ...
    @ReactProp(name = "documentWithPassword")
    public void setDocument(PdfView view,@NonNull ReadableMap document) {
        String password = document.getString("password");
        view.setDocument(document.getString("uri"), password == null || password.isEmpty() ? null : password);
    }
